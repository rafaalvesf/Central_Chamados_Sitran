...
<form  name="form_add_item" onsubmit="return validateFormAddItem()" method="post" action="processa_lixo.php" class="formulario ctexto">
    <br>
	...
	<?php while($linha = mysqli_fetch_array($consulta_lixo)){ ?>
		<?php if($linha['Nome_Produto'] == $_GET['add']){ ?>
			...
			<form method="post" action="processa_lixoADD.php" class="formulario ctexto">
				...
				<input type="text" name="fornecedoree" class="ctexto backformularioinput" placeholder="Escreva o Setor de Origem"  style="text-transform:uppercase"><br><br>
