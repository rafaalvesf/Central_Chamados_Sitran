...
$Msgm="🤖 Olá, acabei de ver que o $User_Atual REGISTROU um $Nome_Produto-$Marca_Produto em nossa lista de controle de COMPRAS. Agora teremos um maior controle sobre suas informações!";
$Request_Params=[
    'chat_id' => $Group_id,
    'text' => $Msgm
];
